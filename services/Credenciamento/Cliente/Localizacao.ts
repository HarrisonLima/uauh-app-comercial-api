import LocalizacaoModel from "../../../models/Credenciamento/Cliente/Localizacao";

const LocalizacaoRepository = require("../../../repositories/Credenciamento/Cliente/Localizacao");
