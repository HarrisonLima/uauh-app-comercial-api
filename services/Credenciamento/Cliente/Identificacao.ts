import IdentificacaoModel from "../../../models/Credenciamento/Cliente/Identificacao";

const IdentificacaoRepository = require("../../../repositories/Credenciamento/Cliente/Identificacao");
