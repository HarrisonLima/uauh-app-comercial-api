import RemanejacaoModel from "../../../models/Credenciamento/Cliente/Remanejacao";

const RemanejacaoRepository = require("../../../repositories/Credenciamento/Cliente/Remanejacao");
